            ...
            <tbody>
                <?php foreach($suppliers as $supply): ?>
                    <tr>
                        ...
                        <td style="width: 150px"><?php echo $supply['phone']; ?></td>
                        <td style="width: 500px"><?php echo $supply['obs']; ?></td>
                        <td>
                            <img src="<?php BASE_URL; ?>assets/icons/edit.png" style="width: 30px; margin-right: 5px; cursor: pointer" onclick="editSupplier(<?php echo $supply['id']; ?>)">
