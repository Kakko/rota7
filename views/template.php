...
<head>
    ...
    <script src="https://kit.fontawesome.com/7a15ff60cc.js" crossorigin="anonymous"></script>
</head>
<body>
    <div class="totalArea">
        <div class="topArea">
        ...
        <div class="sysArea">
            <div class="leftMenu">
                ...
                <div class="dropdownArea" id="client_drop">
                    ...
                    <div class="drop_item">
                        <a href="<?php echo BASE_URL; ?>clients/add_clients" style="text-decoration: none">
                            <img src="<?php echo BASE_URL; ?>assets/icons/add_icon.png">
                            <span class="drop_span">Adicionar</span>
                        </a>
                    </div>
                </div>
                <!-- FORNECEDORES -->
                ...
                <div class="dropdownArea" id="services_drop">
                    <div class="drop_item">
                        <a href="<?php echo BASE_URL; ?>services/search_services" style="text-decoration: none">
                            <img src="<?php echo BASE_URL; ?>assets/icons/magnifier_icon.png">
                            <span class="drop_span">Buscar Serviços</span>
                        </a>
                    </div>
                    <div class="drop_item">
                        <a href="<?php echo BASE_URL; ?>services/add_service" style="text-decoration: none">
                            <img src="<?php echo BASE_URL; ?>assets/icons/add_icon.png">
                            <span class="drop_span">Adicionar</span>
                        </a>
                    </div>
